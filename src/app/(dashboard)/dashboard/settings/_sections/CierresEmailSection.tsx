...
const CLOSURE_FREQ_OPTIONS = [
  { value: 'daily',   label: 'Diario (se envía cada mañana)' },
        ...
        <form onSubmit={handleSave} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-xs text-muted">
              El email se envía al OWNER del comercio con el total y el desglose por método de pago.
            </p>
            <select
              id="closure-freq"
              value={freq}
              ...
              disabled={!canEdit}
              className="mt-1 rounded-lg border border-border bg-card px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary disabled:cursor-not-allowed disabled:opacity-60"
            >
